...
%% HOGG: Comment about the fact that at exact precision the magnitude shouldn't matter but in practice it does.
%% US: We will add a description of the experimental setup (dimensionless stuff) in the appendix.
%% US: New experiment: covariance in data normalization
%HOGG: write the appendix on the black body experiment
%SOLE: write the experiment on data normalization
