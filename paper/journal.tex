...
% - Where to submit this? If we submit to Nature Communications, the setup is:
%   - un-headed introduction (which will include glossary)
%   - Results
%   - Discussion
%   - Methods (maybe in smaller font).
